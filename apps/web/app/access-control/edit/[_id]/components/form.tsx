...
import { createAccountAction } from "@/actions/access-control/add-access-control";
...
import { z } from "zod";
import { updateAccessControlAction } from "@/actions/access-control/update-access-control";
...
export default function EditAccountForm({ accountDetails }) {
  ...
  const form = useForm<z.infer<typeof schema>>({
    ...
    defaultValues: _.merge({ password: "" }, accountDetails),
  });

  const onSubmit = async (data) => {
    const { success, message } = await updateAccessControlAction(
      data,
      accountDetails._id
    );
    if (success) {
